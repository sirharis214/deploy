...
/usr/bin/sshpass -p ${pAs} ssh -t root@"${IP_D}" "cd /home/${USER_M}/QA/Files/; sudo rm *.zip; cd /var/www/ishop/; sudo yes | cp -rf ./* ../Backup/"
...
/usr/bin/sshpass -p ${pAs} ssh -t root@"${IP_D}" "sudo unzip -o /home/${USER_M}/QA/Files/${FILE} -d /var/www/ishop/"
